...
class VehicleEnrichmentManager:
    ...
    def _build_async_vehicle_attribute_result(self, prepared: PreparedTrackEnrichment, attribute_result: Any) -> TrackEnrichmentResult:
        ...
        return self._build_base_result(
            ...
            plate_readable=plate_aggregate["plate_readable"],
            plate_text=plate_aggregate["plate_text"],
            plate_raw_text=plate_aggregate["plate_raw_text"],
            plate_normalized_text=plate_aggregate["plate_normalized_text"],
            plate_validation_status=plate_aggregate["plate_validation_status"],
            plate_validation_reason=plate_aggregate["plate_validation_reason"],
            plate_format_type=plate_aggregate["plate_format_type"],
            plate_correction_applied=plate_aggregate["plate_correction_applied"],
    ...
    def _build_base_result(
        ...
        *,
        ...
        return TrackEnrichmentResult(
            ...
            plate_readable=plate_readable if plate_readable is not None else plate_detected and plate_text is not None,
            plate_colour=None,
            registration_category=None,
            plate_text=plate_text,
            status=status,
            plate_raw_text=plate_raw_text,
            plate_normalized_text=plate_normalized_text,
            plate_validation_status=plate_validation_status,
            plate_validation_reason=plate_validation_reason,
            plate_format_type=plate_format_type,
            plate_correction_applied=plate_correction_applied,
