...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default=None,
        help="Optional pipeline config to launch alongside the API.",
    )
...
def main() -> None:
    ...
    if args.run_pipeline:
        ...
        thread = threading.Thread(target=run_pipeline, args=(config_path,), daemon=True, name="pipeline-thread")
        thread.start()
