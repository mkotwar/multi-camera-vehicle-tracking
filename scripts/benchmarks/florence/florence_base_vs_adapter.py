...
CONFIG_AUDIT_PATHS = [
    "config.yaml",
    "config/archive/config.validation_florence_body_type.yaml",
    "config/archive/config.validation_florence_body_type_colour.yaml",
    "config/archive/config.validation_florence_body_type_colour.balanced.yaml",
    "config/archive/config.validation_florence_body_type_colour.strict.yaml",
]
